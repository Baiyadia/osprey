...
public enum ErrorCodeEnum implements ErrorCode {
    ...
    TOKEN_EXPIRATION(1000, 401, "error.code.security.800"),
    TOKEN_INVALID(1000, 401, "error.code.security.801"),
    TOKEN_FORBIDDEN(1000, 403, "error.code.security.803"),
    TOKEN_ABNORMAL_ACCESS(1000, 401, "error.code.security.804"),
    TOKEN_BIZ_FROZEN(1000, 403, "error.code.security.805"),
